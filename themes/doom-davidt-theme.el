;;; doom-davidt-theme.el --- inspired by VS code's Moonlight
(require 'doom-themes)

;;
(defgroup doom-davidt-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-davidt-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-davidt-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-davidt
...
;;   (base5      '("#383e5c" "#585858" "brightblack"))
   (base5      '("#686e8c" "#585858" "brightblack"))
;;   (base6      '("#7e8eda" "#626262" "brightblack"))
   (base6      '("#4ede8a" "#626262" "brightblack"))
   ...
   (modeline-fg     "white")
   (modeline-fg-alt "#7e8eda")

   (-modeline-pad
    (when doom-davidt-padded-modeline
      (if (integerp doom-davidt-padded-modeline) doom-davidt-padded-modeline 4))))
...
(provide 'doom-davidt-theme)

;;; doom-davidt-theme.el ends here
