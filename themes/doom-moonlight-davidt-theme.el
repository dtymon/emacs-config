...
;;
(defgroup doom-moonlight-davidt-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-moonlight-davidt-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-moonlight-davidt-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-moonlight-davidt
...
;;   (base5      '("#383e5c" "#585858" "brightblack"))
   ...
   (-modeline-pad
    (when doom-moonlight-davidt-padded-modeline
      (if (integerp doom-moonlight-davidt-padded-modeline) doom-moonlight-davidt-padded-modeline 4))))
...
(provide 'doom-moonlight-davidt-theme)

;;; doom-moonlight-davidt-theme.el ends here
